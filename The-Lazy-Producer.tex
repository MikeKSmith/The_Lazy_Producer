...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, toprule=.15mm, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, opacityback=0, breakable, leftrule=.75mm, coltitle=black, colback=white, rightrule=.15mm, arc=.35mm, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Note Range}, opacitybacktitle=0.6, left=2mm, colbacktitle=quarto-callout-tip-color!10!white]
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Chord_Live12.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Echo_Noise_Generator.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Drift_Instrument.png}}

Then the device will be placed into an Instrument or Effect Rack ready
for you to assign parameters to the macro knobs:

\pandocbounded{\includegraphics[keepaspectratio]{images/Drift_Instrument_Rack_blank.png}}

Returning to the Faded Keys preset for Drift:

\pandocbounded{\includegraphics[keepaspectratio]{images/Drift_Instrument_FadedKeys.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Drift_Instrument_Rack_MacroRange.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Drift_Instrument_Rack_MacroRange2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Drift_Instrument_Rack_Exclude.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Macro_Variations.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Markov_Variations.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Natural_Selection_P.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Instrument_Rack.png}}
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, toprule=.15mm, bottomrule=.15mm, colframe=quarto-callout-caution-color-frame, bottomtitle=1mm, opacityback=0, breakable, leftrule=.75mm, coltitle=black, colback=white, rightrule=.15mm, arc=.35mm, toptitle=1mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Continue to use Scale Device in live performance!}, opacitybacktitle=0.6, left=2mm, colbacktitle=quarto-callout-caution-color!10!white]
