...
Stokes, Yokermoon, kale, Andrew Tasselmyer, Bad Snacks, Benn Jordan,
Catalyze Music Academy, DivKid, Fors, Andrew Huang, Loopop, Misty Jones,
Ned Rush, Novel Music, Omri Cohen, Philip Meyer, Red Means Recording,
Seed to Stage, Steve Lawson, Ted Laderas.
...
\begin{tcolorbox}[enhanced jigsaw, breakable, titlerule=0mm, bottomrule=.15mm, arc=.35mm, coltitle=black, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Key idea}, opacityback=0, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, colback=white, left=2mm, opacitybacktitle=0.6, toptitle=1mm, rightrule=.15mm, toprule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, titlerule=0mm, bottomrule=.15mm, arc=.35mm, coltitle=black, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Note Range}, opacityback=0, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, colback=white, left=2mm, opacitybacktitle=0.6, toptitle=1mm, rightrule=.15mm, toprule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-tip-color!10!white]
...
``Instrument Racks'' or ``Effect Racks'' in one track (see
\url{https://www.ableton.com/en/live-manual/12/instrument-drum-and-effect-racks}).
However, the benefit from the approach above is that each track can then
use Return track sends to apply effects. It also makes live performance
...
and a Velocity plugin to add a little variation to the velocity of the
output MIDI notes.
...
there wasn't a perceptible pattern or period to its output. So I took a
...
forms something much more interesting and evolving. All this BEFORE
drowning it in reverb and delay.
...
``DNA'' of the original audio is present, but it is smeared, chopped and
sliced in playback.
...
that channel is sending audio back to Return A. As we've mentioned
above, using feedback to route audio signal between Return channels is a
little risky as sound can sometimes build up quickly if channels are
eventually routed back into themselves. Adding a Limiter to the Return
or Main channels would prevent runaway sound feedback causing physical
...
playing. This does \textbf{\emph{NOT}} mean you enter into it
unprepared. In fact, the better the preparation, the better the
improvisation. So you can set up your randomness and probability to
generate phrases, fills, weird rhythms, change chords, throw in some
interesting notes in melodies. But maybe the best way to work with that
is to improvise alongside it. If you're able.
...
\begin{tcolorbox}[enhanced jigsaw, breakable, titlerule=0mm, bottomrule=.15mm, arc=.35mm, coltitle=black, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Continue to use Scale Device in live performance!}, opacityback=0, colframe=quarto-callout-caution-color-frame, bottomtitle=1mm, colback=white, left=2mm, opacitybacktitle=0.6, toptitle=1mm, rightrule=.15mm, toprule=.15mm, leftrule=.75mm, colbacktitle=quarto-callout-caution-color!10!white]
...
One key point about the Generator tools is that they are primarily
design to generate new MIDI clips during music production, rather than
``on the fly'' during performance. Unfortunately at this point they
cannot be automated.
...
The recipes here are not intended as definitive versions of any idea,
but rather some practical inspiration of what might be possible. Feel
free to use them, adapt them and take techniques that resonate with you
...
\url{https://mikeksmith.bandcamp.com/album/the-lazy-producer}. If you
purchase the album via Bandcamp you'll get a PDF copy of this book as
part of the download. The book is also available via Amazon Kindle
Direct Publishing both as an ebook and in paperback. If you purchase the
book via Amazon, please email
...
If you would like to contribute to future versions of this book, I would
welcome your thoughts, corrections, extensions and ideas via the Github
repository for the book. Please submit an Issue here:
