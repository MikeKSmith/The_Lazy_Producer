...
Why put a sequencer inside a DAW (which is, itself, a sequencer)? Well, because
...
sequence and gate (whether the note occurs or not) sequence can be completely
...
octave and other attributes can have different sequence lengths. To create a "gate" sequence with MIDI, you can simply set the velocity of certain steps to zero, which effectively silences those notes.
...
Step Sequencer within the MIDI tab.
...
This is a powerful sequencer, capable of providing endless variation and interest from even the simplest patterns.
