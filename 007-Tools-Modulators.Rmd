...
```{r}
knitr::include_graphics(path = "./images/LFO_Stray.png")
```

```{r}
knitr::include_graphics(path = "./images/LFO_Glider.png")
```
...
```{r}
knitr::include_graphics(path = "./images/Expression_Control_Live12.png")
```
