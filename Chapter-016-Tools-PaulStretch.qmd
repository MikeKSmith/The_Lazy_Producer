...
[PaulXStretch](https://sonosaurus.com/paulxstretch/) is a third party audio effect plugin that stretches audio files to extreme lengths, transforming them into evolving soundscapes and textures. This is not the type of stretching that is available in Ableton for warping audio by a few bpm to fit a different tempo, but instead is about sonic manipulation even to extreme amounts.
