...
You can play or program in sequences to be used as the basis for generative music, and we did exactly this for [Recipe - Changing chords](001-Recipe-Changing_Chords.qmd)
. But to create melodic or note sequences you may also wish to use a MIDI note generator like those discussed below. All of these devices will create MIDI note sequences - all of them can use random probability to generate note sequences that constantly change or evolve. As we have discussed in the section [Process - Balancing the unexpected and the predictable](009-Process-Balance_unexpected_and_predictable.qmd)
...
[Tools - Live 12 Sequencers](031-Tools-Live12_Sequencers.qmd)
.
