...
sometimes the composer worked with actual tape loops. The concept is
...
So primes are nice for preventing repetition in the grand scheme of
...
Ratio" where the sizes of the squares are grow in relation to the ratio
