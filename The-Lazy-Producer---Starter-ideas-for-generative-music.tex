...
\urlstyle{same}
\hypersetup{
  pdftitle={The Lazy Producer - Starter ideas for generative music},
...
\title{The Lazy Producer - Starter ideas for generative music}
\author{Mike K Smith}
\date{2025-06-09}
\begin{document}
...
% Title and subtitle
{{\Huge{\textbf{\nohyphens{The Lazy Producer - Starter ideas for
generative music}}}}\par
}%
}
...
\chapter{Recipe - Changing chords}\label{001-Recipe-Changing_Chords}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe1_Track1_Chord1.png}}

\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe1_Track1_Chord2.png}}

\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe1_Track1_Chord3.png}}

\textbf{\emph{Track 2 clips}}:

\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe1_Track2_Chord1.png}}

\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe1_Track2_Chord2.png}}

\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe1_Track2_Chord3.png}}

\textbf{\emph{Track 3 clips}}:

\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe1_Track3_Chord1.png}}

\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe1_Track3_Chord2.png}}

\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe1_Track3_Chord3.png}}
...
movement and retain interest (see \hyperref[004-Tools-MIDI_tools]{Tools
- MIDI tools} for more details on MIDI effects in Ableton Live).
...
\item
  ...
  \hyperref[003-Process-Follow_Actions]{Process - Follow Actions} ) to
  progress to Next clip at end of each clip with 80\% probability, with
  the other action set to ``Play again'' with 20\% probability. When you
  launch the scene, each clip will play to the end of the clip, but
  because individual note probability within each of the stacked chords
  is set to 50-60\%, the chord will sound different each time it plays.
  Also, the randomness we're using for note probability means that the
  same chord clip in each track is also likely to sound different. The
  80-20\% split of next action - ``Play again'' or ``Next'' - will mean
  that some tracks may progress to the next chord while some will play
  the same clip again.
\end{enumerate}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Probability_Drumkit_HH.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Probability_Drumkit_KickSnare.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/NoteWiseProbability_Full_pattern.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/NoteWiseProbability_Lower_notes.png}}

Higher part on a separate track: (Again - ``greyed out'' notes will not
play)

\pandocbounded{\includegraphics[keepaspectratio]{images/NoteWiseProbability_Higher_notes.png}}
...
In \hyperref[001-Recipe-Changing_Chords]{Recipe - Changing chords} , I
suggested using probability on the notes within chords. If you add 8
MIDI notes in a chord and specify 50\% probability for all of them, then
Ableton is going to (effectively) toss a coin for each note. In the real
world, when we toss a coin 8 times, we don't always get 4 heads and 4
tails. Sometimes we get 3 heads, 5 tails (or vice versa), and
occasionally outcomes like 2 heads, 6 tails. Imagine if in the coin
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Note-wise_probability.png}}
...
\hyperref[018-Process-Scales]{Process - Using scales}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Launch_Follow-Actions.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Launch_Follow-Actions_Linked.png}}
...
notes}\label{004-Tools-MIDI_tools}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Note_Echo.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Random.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Note_Length.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Scale.png}}

\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, leftrule=.75mm, coltitle=black, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, opacityback=0, colback=white, arc=.35mm, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, toptitle=1mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Note Range}, left=2mm, breakable]
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Pitch_Scale_Range.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Chord.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Cascading_notes.png}}
...
\hyperref[012-Tools-MIDI_Generators]{Tools - MIDI Generators} ) which
are constantly generating 1/8th or 1/16th notes. Use of a probability
gate ``thins out'' that stream of output.

\pandocbounded{\includegraphics[keepaspectratio]{images/Probability_Gate.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Deviate_MIDI.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Tintinnabulator.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Schwarzonator.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Nordmann_chord.png}}

\bookmarksetup{startatroot}

\chapter{Process - Routing MIDI and Audio}\label{005-Process-Routing}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Routing.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe2_MODULATION_Shaper-gain.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe2_MIDI-and-audio-routing.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe2_MIDI_fx.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe2_MIDI_manipulation.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe2_MIDI_NoteLength.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe2_MIDI_Arp.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Expression_control.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Expression_control_2.png}}
...
\chapter{Tools - Modulators}\label{007-Tools-Modulators}
...
sequences, but we can also automate changing the value of pretty much
...
\hyperref[009-Process-Balance_unexpected_and_predictable]{Process -
Balancing the unexpected and the predictable} we discuss how repetition
balances randomness. This also applies to the sounds you use in your
track. Modulation of synth sounds through LFOs and other means is
available within Ableton Live instruments, often with some very creative
ways of achieving that - such as the Wavetable instrument's modulation
matrix. But sometimes you want to apply modulation to a parameter where
an LFO is not immediately available for example to the macro knob of an
Instrument or Effect Rack.
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Labs.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Zebralette_Configure.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Zebralette.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Zebralette_Configured.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/LFO.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Chaotic_LFOs.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/MIDI_envelope.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Envelope_follower.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Shaper.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Strange_mod.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Dispatch.png}}

\section{Deviate}\label{deviate-1}

We've come across the free
\href{https://www.novelmusic.org/m4l/deviate}{Deviate Max for Live
device from Novel Music} in \hyperref[004-Tools-MIDI_tools]{Tools - MIDI
tools} , but it also offers random modulation control on parameters. You
can dial up randomness at various levels in Deviate, and also control
the amount of randomness which is very useful in generative music. But
it also has a key feature - the ability to monitor parameter deviations
in its ``MEMORY'' and then ``Lock'' in patterns if you find something
you like - this mirrors functionality in Turing Machine modules that
exist in the modular synthesis world.
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Deviate_map.png}}
...
predictable}\label{010-Recipe-Balance_random_and_predictable}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe3_Piano1.png}}

\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe3_Piano2.png}}

\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe3_Piano3.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe3_Piano_Random.png}}
...
\item
  ...
  \hyperref[004-Tools-MIDI_tools]{Tools - MIDI tools} ) to add some
  variation on the notes being played. This means that each time the
  loop repeats you will hear a different set of notes. On its own, this
  would be ``too much randomness''. But because this sits alongside a
  predictable repeating part, it will sound more grounded.
\end{itemize}

\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe3_Piano_Random_MIDIFX.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe3_Pads.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe3_DrumKit.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe3_Ableton_Set.png}}
...
ideas}\label{011-Process-Workflow-Capturing_Ideas}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Workflow1_MIDI.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Workflow2_Group.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Workflow3_Rendered.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Melodic_Steps.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Bouncy_notes.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Dr_Chaos.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Euclidean_sequencer_pro.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Less_concepts.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Turing_Machine.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/MIDI_waves.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Midivolve.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Polymath.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Polymath_offset.png}}
...
\hyperref[004-Tools-MIDI_tools]{Tools - MIDI tools} and
\hyperref[005-Process-Routing]{Process - Routing MIDI and Audio} .
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe4_EuclideanSequencerPro.png}}
...
\item
  ...
  \hyperref[004-Tools-MIDI_tools]{Tools - MIDI tools} , where we take
  the output from the Euclidean sequencer and then route it to a number
  of different synth engines while also applying some additional MIDI
  tool processing.
\end{enumerate}

\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe4_Routing.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe4_Operator.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe4_Pad.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe4_Arp.png}}
...
\item
  ...
  \hyperref[012-Tools-MIDI_Generators]{Tools - MIDI Generators} , such
  as Bouncy Notes, Turing Machine, Less Concepts, etc. The MIDI
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Pinging_Filters.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Resonators.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Tree_tone.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Harmonic_Drone_Generator.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Cellular_Degradation.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Hybrid_Reverb.png}}
...
discussed in \hyperref[016-Tools-PaulStretch]{Tools - Extreme audio
stretching with PaulStretch} and you'll have instant drones.
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Valhalla_Supermassive.png}}
...
discussed in \hyperref[007-Tools-Modulators]{Tools - Modulators} While
the timing of the Echo is fixed, we have other parameters that mean that
the sound is constantly shifting in an unpredictable way. This will
prevent the Echo effect from being too ``samey'' across the track and
provide some interesting moments. It's a bit like having a pair of
``robot hands'' that tweak the Echo settings.

\pandocbounded{\includegraphics[keepaspectratio]{images/LFO_Echo.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Saturator_Pedal.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Roar.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Resonator.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Spectral_Devices.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Spectral_Averaging.png}}

\pandocbounded{\includegraphics[keepaspectratio]{images/Spectral_Blurring.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Shifter.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Corpus.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Envelope_Follower_Send.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/paulxstretch_screenshot.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe5_TreeTone.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe5_HarmonicGenerator.png}}
...
\item
  ...
  \hyperref[014-Tools-Audio_Generators]{Tools - Audio Generators} , this
  is a weird instrument combining 5 different stereo FM oscillators, and
  it can make some VERY weird noises. That's what we're going to do
  here. Normally you ``draw'' into the main panel to make cells
  ``alive'' and then the cellular birth and death process retains these
  or allows them to ``die''. To automate that process we're using
  another favourite Dillon Bastan plugin, the Strange Mod modulation
  device. We can then use its chaotic modulation processes to automate
  ``drawing'' the X and Y values. This should produce some very strange
  buzzy textures.
\end{enumerate}

\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe5_CellularDegradation.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe5_CellularDegradation_Resonator.png}}
...
\chapter{Process - Using Scales}\label{018-Process-Scales}

As discussed in \hyperref[004-Tools-MIDI_tools]{Tools - MIDI tools} ,
scale quantisation is a widely used tool to harness the random note
values from MIDI Generators. It provides \emph{just enough} quantising
to turn something unlistenable into something that's still random, but
perhaps more listenable. The problem is that even within a defined
scale, there are sometimes notes that will irritate the listener if they
happen too often - for example in the C Major scale, the note B - one
semitone below or 11 semitones above the root is always going to be a
bit jarring. In the context of most Western music that note is often
played in passing on the way back to the root note C. But in the context
of random note generators it may pop up a little too often for comfort
and not always resolve to the C. So what do we do? Avoid Major scales?
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Sampler_Drone_Global.png}}

\pandocbounded{\includegraphics[keepaspectratio]{images/Sampler_Drone_Modulation.png}}
...
\tightlist
\item
  Using techniques described in \hyperref[015-Tools-Audio_Effects]{Tools
  - Creative use of audio effects} and used in the
  \hyperref[017-Recipe-Audio_generators_drone]{Recipe - Making a drone
  using some audio generators and effects} set up a network of audio
  effects on effect sends / Return channels.
\end{enumerate}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Recipe-Sampler_drone.png}}
...
\chapter{Process - Unsynced loops}\label{021-Process-Unsynced_loops}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{images/Fibonacci_Spiral.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Fibonacci_Polymeters.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Fibonacci_FX.png}}
...
tools}\label{030-Tools-Live12_Intro}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Live12_Scale.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Live12_Random_ScaleAware.png}}

So now we can chain together MIDI Devices as discussed in
\hyperref[004-Tools-MIDI_tools]{Tools - MIDI tools} and used in
\hyperref[006-Recipe-MIDI_tools]{Recipe - Doing more with less using
MIDI tools and plugins} and by turning on Scale Awareness we'll pick up
whatever the Current Scale setting is. Note in the Chord and Arpeggiator
devices that instead of ``st'' semitones for shifting, it is now
labelled ``sd'' scale degrees. This takes a little getting used to
because the scale degrees are added onto the MIDI note value - so +4sd
is a fifth above the incoming MIDI note.

\pandocbounded{\includegraphics[keepaspectratio]{images/Live12_ScaleAware_MIDI_Devices.png}}
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, leftrule=.75mm, coltitle=black, bottomtitle=1mm, colbacktitle=quarto-callout-caution-color!10!white, bottomrule=.15mm, opacityback=0, colback=white, arc=.35mm, colframe=quarto-callout-caution-color-frame, opacitybacktitle=0.6, toptitle=1mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Continue to use Scale Device in live performance!}, left=2mm, breakable]
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Live12_MIDIGenerators.png}}

\pandocbounded{\includegraphics[keepaspectratio]{images/Live12_Max_MIDIGenerator.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Live12_Euclidean_Pattern.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Live12_MIDI_Transformers.png}}

We'll look at MIDI Generation and Transformation tools a little more in
\hyperref[033-Tools-Live12_MIDI_Generation_Transformation]{Tools - Live
12 MIDI Generation and Transformation}.

\section{Note probability}\label{note-probability}

In \hyperref[002-Process-Note_wise_probability]{Process - Note-wise
probability} , we looked at Notewise probability - where we can set the
probability for each note in a sequence, so we can generate ever
changing patterns even from fairly short sequences of MIDI notes. Live
12 has another fantastic feature where we can \textbf{\emph{group}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Live12_GroupNotes.png}}
...
\chapter{Tools - Live 12 Sequencers}\label{031-Tools-Live12_Sequencers}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Live12_SQ.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Live12_RhythmicSteps.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Live12_StepArp.png}}
...
\chapter{Tools - Live 12 Modulation}\label{032-Tools-Live12_Modulation}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Live12_LFO_Glider.png}}
...
amount or rates (as discussed in \hyperref[007-Tools-Modulators]{Tools -
Modulators} . ``Glider'' Waveform makes that much easier.
...
\pandocbounded{\includegraphics[keepaspectratio]{images/LFO_Stray.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Live12_LFO_shape_steps.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Expression_Control_Live12.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/Live12_Shaper.png}}

\bookmarksetup{startatroot}

\chapter{Tools - Live 12 MIDI Generation and
Transformation}\label{033-Tools-Live12_MIDI_Generation_Transformation}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/MIDI_Generator_MDDSnake.png}}
...
\hyperref[012-Tools-MIDI_Generators]{Tools - MIDI Generators}. Turing
Machines create random sequences of notes and this MIDI Generator Max
for Live device by Philip Meyer is essentially a little Turing Machine
that will create a clip full of notes for you. Because the Turing
Machine produces random note patterns, it's worth experimenting and
generating a few patterns until you find one that works in context.
Philip Meyer explains the device in more detail in this video:
https://youtu.be/\_LpA66peATg?si=-KgyOTrVt\_sbTgv6\&t=2191.

\pandocbounded{\includegraphics[keepaspectratio]{images/MIDI_Generator_TuringMachine.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/MIDI_Transformer_Develop.png}}
