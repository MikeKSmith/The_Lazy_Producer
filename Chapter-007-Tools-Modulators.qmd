...
```{r}
#| fig-alt: "Image shows the Envelope MIDI device. This device is set up to follow an Attack Decay Sustain and Release pattern modulating the filter cutoff, triggered by every incoming MIDI note event."
