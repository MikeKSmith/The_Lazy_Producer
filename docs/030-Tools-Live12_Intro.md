...
Note that MIDI clips set Current Scale, so if you wish to change the Current Scale, it's worth checking that ***ALL*** MIDI clips within a scene or all MIDI clips playing have the same scale setting. See <https://help.ableton.com/hc/en-us/articles/11425083250972-Keys-and-Scales-in-Live-12-FAQ>
