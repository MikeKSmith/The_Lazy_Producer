...
This Recipe comes from DivKid (Ben Wilson) who shared it on his [Instagram](https://www.instagram.com/divkidvideo) channel. I'm very grateful to Ben for giving me permission to share this idea in this Recipe. I would encourage you to check out DivKid's content (<https://www.youtube.com/divkidvideo>) - he has a lot of really great tutorials, walkthroughs and ideas for use with modular synth rigs, but which can also be applied to Ableton Live. You can also sign up to his [Patreon](https://www.patreon.com/DivKid) where if you sign up as a Patron you can download a copy of the Ableton set that goes with this Recipe.
...
4\. In his example set, DivKid has used plucky Operator with Sine tones but with additional tone shaping and granular delay to the grouped tracks which breathes life into the results and prevents them from becoming too stale.
