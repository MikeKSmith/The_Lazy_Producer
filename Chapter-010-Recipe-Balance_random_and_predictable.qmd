...
1.  Create a short melodic phrase in a MIDI track. I’ve made three separate clips, each with a Follow Action set to advance to the next clip after four repetitions.
...
2.  On another track, create a second part that complements the first melodic phrase. Loop this part as well. Ensure that the second part is distinguishable
...
3.  Now, you have a few options for this second part:
...
-   I also like to add a delay to this second part, either with delay on the track itself or as a Return track. Because the notes are more sparse you can add more effects to them and they will stand out over the repeating, predictable melodic line. A higher pitch or brighter tone for this second part will also help it stand out. If you are using a Return FX channel with Delay, then you can send the predictable part to this delay at a lower level than the second part. That will mean the unpredictable, higher or brighter tone part "pings out" over the more predictable part.
...
5.  I've also created a simple, repeating pad pattern that loops continuously. This part is completely predictable and adds a "grounding" element to the track.
This counterbalances the random parts elsewhere.
...
on the Hihat part. Feel free to add a Beat Repeat audio effect on this part to provide
...
9.  Press play. Listen to what you hear, and refine settings if necessary.

------------------------------------------------------------------------

An example of this recipe can be found here: [https://soundcloud.com/mikeksmith/3_balancing_predictable_unpredictable_l12-3](https://soundcloud.com/mikeksmith/3_balancing_predictable_unpredictable_l12-3){.uri}
