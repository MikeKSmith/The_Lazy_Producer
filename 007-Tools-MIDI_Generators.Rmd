...
```{r}
knitr::include_graphics(path = "./images/Melodic_Steps.png")
```
...
```{r}
knitr::include_graphics(path = "./images/Bouncy_notes.png")
```
...
```{r}
knitr::include_graphics(path = "./images/Dr_Chaos.png")
```
...
```{r}
knitr::include_graphics(path = "./images/Euclidean_sequencer_pro.png")
```
...
```{r}
knitr::include_graphics(path = "./images/Less_concepts.png")
```
...
```{r}
knitr::include_graphics(path = "./images/MIDI_waves.png")
```
...
```{r}
knitr::include_graphics(path = "./images/Midivolve.png")
```
...
```{r}
knitr::include_graphics(path = "./images/Polymath.png")
```
