...
in passing on the way back to the root note C. But with a random note generator, that B might pop up too often for comfort, without resolving to C. So what do we do? Avoid Major scales?
...
to imply a change of key through a root note change in a bass instrument, without having to
change the scale for the generated (or quantised) MIDI.
  
:::

## Pentatonics - Minor and Major

You know how you can play only the black keys on a piano, and no matter what you do, it somehow sounds good? That's
because you are playing a pentatonic scale. Many "serious musicians" will scoff
...
modes and harmonies. But for most generative purposes, ***pentatonic
scales are your absolute number 1 safest pick***. You can combine any number of
...
Modal scales can seem hard to wrap your head around at first, but in practice, they're quite simple.Take the notes in the scale of C, start on
...
But in generative music, we can't guarantee our system will provide that context or resolve a dissonant note to something more pleasant.
...
## Context provided via the bass instrument

Often you will find that the bass notes you program or play against the generative chords and parts in the higher register will be sufficient to provide a solid anchor and context. For this reason I tend not to use random note processes in the bass parts, and in fact in many cases this might be the only part in a composition that I actually "play".
...
With Ableton's Scale MIDI effect and scale awareness you
