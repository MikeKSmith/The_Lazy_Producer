# Tool - Variations {#Chapter-025-Tools-Variations}
...
The idea in this device is that you can select "Parent" Variations that you want the next Generation to evolve from, add chaos or mutation and then create a new generation of Variations. This approach to [Tools - Random Sound Design](#Chapter-024-Tools-Random_Sound_Design) is slightly less "Random" than simply clicking on the Random button in the Macro knobs area and may be more useful if you are looking for something that is "like" another Variation but not quite.

Another device in the Natural Selection devices bundle takes a similar approach but using parameters of a synthesis engine to create new sound design ideas - [Natural Selection S](https://dillonbastan.com/store/maxforlive/index.php?product=natural-selection-s).
