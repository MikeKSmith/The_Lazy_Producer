...
You can hear my version of this track here: [https://soundcloud.com/mikeksmith/4_euclidean_midigenerator-4](https://soundcloud.com/mikeksmith/4_euclidean_midigenerator-4){.uri}

```{r, echo=FALSE, results = "asis"}
htmltools::includeHTML(path = file.path("HTML","Recipe4-Euclidean-NonRhythm.html"))
```
