...
In this recipe, we’ll use a MIDI generator—in this case, Euclidean Sequencer Pro—to create the initial MIDI pattern, which we'll then feed into other tracks for further processing. We'll be using some techniques from 
