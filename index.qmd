...
![](images/Album_Cover.png){fig-alt="Album cover for Mike K Smith's album \"The Lazy Producer\". The cover shows a generative art image created by Danielle Navarro which has two concentric circles white on indigo and black with many white slashes and whispers. The image has four quadrants. Near the centre are three V-shapes" fig-align="center"}
